...
if (isset($_POST['upload'])) {
  ...
  if ($tipe_file == IMAGETYPE_JPEG || $tipe_file == IMAGETYPE_PNG || $tipe_file == IMAGETYPE_GIF) {
    ...
    echo "<script>alert('Upload foto berhasil !');location='user.php?page=user_gantipassword';</script>";
  } else {
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="mt-5 text-center">
            <button class="btn btn-success profile-button" type="submit" name="Ganti" id="Ganti">Simpan</button>
          </div>
        </div>
      </div>
    </div>
